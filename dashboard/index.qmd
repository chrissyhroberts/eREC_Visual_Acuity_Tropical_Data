...
df <- df %>%
  mutate(
    ...
    jittered_longitude = jitter(rounded_longitude, amount = 0.003),
    jittered_latitude = jitter(rounded_latitude, amount = 0.003)
  )
...
map <- map %>%
  addCircleMarkers(
    ...
    clusterOptions = markerClusterOptions(
      ...
      disableClusteringAtZoom = 14  # Stop clustering at this zoom level
    )
  )
