...
df<-df %>% 
  mutate(
    person_location_cluster =
      case_when(
                system_device_id=="COLLECT:8MSZQ7J4LG7WXMRT" & splash_form_created_date== "2024-10-29" ~ "unknown_1",
                system_device_id=="COLLECT:8MSZQ7J4LG7WXMRT" & splash_form_created_date== "2024-10-30" ~ "unknown_2",
...
df <- df %>% filter(person_location_cluster!="",
                    system_device_id!="COLLECT:8MSZQ7J4LG7WXMRT") %>% 
 mutate(
