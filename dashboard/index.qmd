...
```{r}
# Display a message about the number of referrals by each method
message("Proportion of participants with bilateral logMAR >= 0.3")
...
geom_errorbar(aes(ymin = ci_lower, ymax = ci_upper), 
  ...
  ggtitle("Proportion with Confidence Intervals by Person Location and Bilateral Fail Status (LogMAR >=0.3)")
)
```
