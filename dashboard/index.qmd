  ...
  mutate(
    person_location_cluster =
      case_when(
                ...
                id == "UUID:002C2D0A-4FFA-43B1-8452-6935390F0572"~"029_MALAMAWA_I",
...
df <- df %>%
 mutate(
  jittered_longitude = custom_jitter(location_geolocation_longitude, amount = 0.003),
  jittered_latitude = custom_jitter(location_geolocation_latitude, amount = 0.003)
)
