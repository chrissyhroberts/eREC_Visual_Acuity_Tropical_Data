...
df <- df %>%
  mutate(
    jittered_longitude = jitter(location_geolocation_longitude, amount = 0.0035),
    jittered_latitude = jitter(location_geolocation_latitude, amount = 0.0035),
    jittered_longitude = round(jittered_longitude, 4),
    jittered_latitude = round(jittered_latitude, 4),
  )
